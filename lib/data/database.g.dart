...
class Post extends DataClass implements Insertable<Post> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, categoryId, body, label, sortOrder, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Post &&
...
final class $$CategoriesTableReferences
  ...
  static MultiTypedResultKey<$PostsTable, List<Post>> _postsRefsTable(
    ...
    db.posts,
    aliasName: 'categories__id__posts__category_id',
  );
          ...
          prefetchHooksCallback: ({postsRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (postsRefs)
                    await $_getPrefetchedData<Category, $CategoriesTable, Post>(
                      currentTable: table,
                      referencedTable: $$CategoriesTableReferences
                          ._postsRefsTable(db),
                      managerFromTypedResult: (p0) =>
                          $$CategoriesTableReferences(db, table, p0).postsRefs,
...
final class $$PostsTableReferences
  ...
  static $CategoriesTable _categoryIdTable(_$AppDatabase db) =>
      db.categories.createAlias('posts__category_id__categories__id');
